...
void CStreamDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, m_rc4txt1);
	DDX_Text(pDX, IDC_EDIT2, m_rc4txt2);
	DDX_Text(pDX, IDC_EDIT3, m_streamkey);
	DDX_Text(pDX, IDC_EDIT4, m_rc4filepath);
	DDX_Control(pDX, IDC_BUTTON5, m_rc4file);
	DDX_Text(pDX, IDC_EDIT5, m_catxt1);
	DDX_Text(pDX, IDC_EDIT6, m_catxt2);
	DDX_Text(pDX, IDC_EDIT7, m_cacell);
	DDX_Text(pDX, IDC_EDIT8, m_cacellnum);
	DDX_Text(pDX, IDC_EDIT9, m_carule);
	DDX_Text(pDX, IDC_EDIT10, m_cafilepath);
